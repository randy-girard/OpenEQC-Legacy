sub EVENT_SAY{
if($text=~/Hail/i){
quest::say("Seek ye the way to avoid Justice. %#1479?'  He laughs a hearty laugh. which fades in and out as his body materialises and dematerialises before you.  'Ye might as well try and escape Time itself.  I spent more than my fair share of time here. an eternity it was.  In the endless millennia that this place has served the universe. there have been more than a few attempts at escape.  Walk the [tunnels] some have. . . but fleeing justice is much like trying to outrun yer own shadow.");
}
if($text=~/what tunnels/i){
