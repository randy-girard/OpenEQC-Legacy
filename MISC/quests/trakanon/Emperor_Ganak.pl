...
sub EVENT_ITEM {
 if($itemcount{19951} == 1 && $itemcount{19952} == 1) {
 ...
 if($itemcount{7276} == 1 && $itemcount{19953} == 1 && $itemcount{19954} == 1 && $itemcount{19955} == 1){
...
#END of FILE Zone:trakanon  ID:95034 -- Emperor_Ganak 
