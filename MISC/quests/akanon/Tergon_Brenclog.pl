...
quest::say("It seems a gnome magician by the name of Toko Binlittle has gone and left the guild. He joined forces with the [Pirates of Gunthak]. Find him. He must be destroyed. Our secrets cannot be known. Return his spellbook to me and I shall give you the [Elemental Grimoire].");
}
...
if($item1=="13387"){
quest::say("Thank you $name. I had no doubt you would fulfill my will and return my spellbook.. here is your reward for such effort.");
quest::faction(91,3);
quest::faction(71,-3);
quest::faction(322,-3);
quest::faction(115,3);
