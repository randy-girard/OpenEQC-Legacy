...
sub EVENT_SAY
{
	if($text=~/hail/i)
	{
		quest::say("Greetings ally of the Claws of Veeshan! Allow me to introduce myself. I am Evreth Menesez of the Draconic Loyalist Fellowship, scholar and researcher of draconic arcane knowledge and practitioner of magery. I am currently researching the whereabouts of an [ancient dragon tome] that my contain lost arcane knowledge that could prove useful to the Claws of Veeshan, particularly the dragons and dragon-kin of Skyshrine.");
	}
	
	if($text=~/ancient dragon tome/i)
	{
		quest::say("The dragon sorcerer, Xervolithax, according to dragon lore had penned a tome of arcane knowledge that he guarded with his life. It is told that when Xervolithax fell to the Kromzek centuries ago in the Great Divide in a great battle. The only surviving apprentice of Xervolithax that survived the fateful incident recovered the tome from the fallen dragon sorcerer and divided it into [sections], which he then hid for fear of the tome falling into the hands of the Kromzek magic-users.");
	}
...
sub EVENT_ITEM
{
	...
	{
		quest::say("By Veeshans claws you've found it! You have done a great service for the residents of Skyshrine Sofaltis! I will make sure that news of your accomplishment reaches the nobles of Skyshrine. Here is the reward that has been promised for your assistance.");
