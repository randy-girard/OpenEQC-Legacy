sub EVENT_SAY { 
if($text=~/Hail/i){
quest::say("Hail!  Nice to see ya, friend.  I've got a fine selection of spankin' good spells, perhaps you'd be interested? Or maybe you'd like to learn how to [upgrade] your Grandmaster Trade items?");
}
if($text=~/i want to upgrade/i){
...
#END of FILE Zone:bazaar  ID:151052 -- Jolum 
