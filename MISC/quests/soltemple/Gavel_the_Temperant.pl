...
sub EVENT_ITEM {
#gauntlets turn in
 if(($itemcount{16507} == 2) && ($itemcount{19010} && $itemcount{19009} == 1))
  {
   quest::say("Well done! You are truly a skilled cleric. I have crafted your gauntlets, here.");
   quest::summonitem(4925);
  }
#weapon turn in
 if(($itemcount{16507} == 2) && ($itemcount{19016} && $itemcount{19015} == 1))
  {
   quest::say("Well done! You are truly a skilled cleric. I have crafted your weapon, here.");
   quest::summonitem(6407);
  }
#chestplate turn in
 if(($itemcount{16507} == 2) && ($itemcount{19011} && $itemcount{19012} == 1))
  {
   quest::say("Well done! You are truly a skilled cleric. I have crafted your chestplate, here.");
   quest::summonitem(4926);
  }
#shield turn in
 if(($itemcount{16507} == 2) && ($itemcount{19013} && $itemcount{19014} == 1))
  {
   quest::say("Well done! You are truly a skilled cleric. I have crafted your chestplate, here.");
