...
sub EVENT_ITEM {
  ...
  #boots
  if($itemcount{2318} && $itemcount{10119} && $itemcount{10561} == 1) {
    quest::say("Excellent. Here are your Lambent Boots.");
    quest::summonitem(4159);
  }

  #gauntlets
  if($itemcount{2319} && $itemcount{10118} && $itemcount{4114} == 1) {
    quest::say("Excellent. Here are your Lambent Gauntlets.");
    quest::summonitem(4157);
  }

  #greaves
  if($itemcount{4115} && $itemcount{10128} && $itemcount{4116} == 1) {
