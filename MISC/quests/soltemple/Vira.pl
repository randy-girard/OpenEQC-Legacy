...
sub EVENT_ITEM {
  ...
  #broom
  if($itemcount{27172} && $itemcount{16543} && $itemcount{16538} && $itemcount{10032} == 1) {
  ...
  #shovel
  if($itemcount{10035} && $itemcount{10014} && $itemcount{16545} && $itemcount{16539} == 1) {
  ...
  #stein
  if($itemcount{16547} && $itemcount{16540} && $itemcount{16542} && $itemcount{10034} == 1) {
  ...
  #torch
  if($itemcount{16546} && $itemcount{16534} && $itemcount{10033} && $itemcount{16541} == 1) {
