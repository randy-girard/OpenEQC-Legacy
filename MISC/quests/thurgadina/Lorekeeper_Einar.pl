...
sub EVENT_SAY { 
  if ($faction <= 3) { # Require greater and kindly faction    
    if($text=~/hail/i){ 
   quest::say("Greetings to you. I seek one that has chosen the path of [monk]hood. What do you call yourself?"); 
    } 
    if($text=~/monk/i){ 
...
sub EVENT_ITEM { 
  if ($faction <= 3) { # Require greater and kindly faction 
   ...
   quest::say("Here's your tunic, use it well."); 
    } 
   ...
   quest::faction(67,20); # Dain Frostreaver IV 
   quest::faction(188,-60); # Kromrif 
   quest::say("Here's your sleeves, use them well.");    
    } 
   ...
   quest::faction(67,20); # Dain Frostreaver IV 
   quest::faction(188,-60); # Kromrif 
   quest::say(Here's your leggings, use them well.); 
    } 
   ...
   quest::faction(67,20); # Dain Frostreaver IV 
   quest::faction(188,-60); # Kromrif 
   quest::say(Here's your gloves, use them well.); 
    } 
   ...
   quest::faction(67,20); # Dain Frostreaver IV 
   quest::faction(188,-60); # Kromrif 
   quest::say("Here's your cap, use it well."); 
    } 
   ...
   quest::faction(67,20); # Dain Frostreaver IV 
   quest::faction(188,-60); # Kromrif 
   quest::say("Here's your bracer, use it well."); 
    } 
   ...
   quest::faction(67,20); # Dain Frostreaver IV 
   quest::faction(188,-60); # Kromrif 
   quest::say("Here's your boots, use them well."); 
    } 
    else { 
