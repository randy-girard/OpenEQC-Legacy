...
if($text=~/what special recipes/i){
...
if($text=~/I will collect the necessary items/i){
...
if($text=~/I am ready to get started/i){
...
quest::say("Fantastic! To create the Proudfoot Boot Material necessary for crafting your Proudfoot Platemail Boots you will need to collect 2 Bricks of Crude Iron Ore. 2 Bat Wings. 2 Water Flasks and 1 Large Wood Spider Tibia .");
quest::summonitem("22612");
}
if($text=~/I want to make greaves/i){
quest::say("I would have to agree that some Greaves are the most important armor piece in any Halfling Warrior's arsenal. If you wish to make the material necessary for these Greaves then gather 4 Bricks of Crude Iron Ore. 2 Ruined Mossy Rat Pelts. 2 Grizzly Bear Skins and 1 Bixie Parts then combine them in your kit. After you have your Proudfoot Greaves Material combine it in the forge with this mold to create your Proudfoot Platemail Greaves.");
...
if($text=~/i will seek retribution/i){
