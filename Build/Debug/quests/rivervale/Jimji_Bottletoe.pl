...
if($text=~/what bravefoot mail bracer/i){
...
if($text=~/what bravefoot  gauntlets/i){
...
if($text=~/what bravefoot  vambraces/i){
...
if($text=~/what bravefoot  greaves/i){
...
if($text=~/what bravefoot  breastplate/i){
...
if($text=~/what bravefoot mail boots/i){
