...
# Kiladiveus - NPC ID:115218(lvl39) and 115150(lvl40) Cobi_Frostbeard, need to change his primary faction to "coldain" 
...
sub EVENT_ITEM { 
  if ($faction <= 3) { # Require warmly and greater faction 
	if (plugin::check_handin(\%itemcount, 25805 => 3, 24942 => 1)) { # tunic - 
		...
		quest::emote("Cobi smiles warmly as she hands your reward.");
