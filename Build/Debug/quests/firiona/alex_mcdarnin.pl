...
#Need Ending Statements and Factions
#Status: NOT COMPLETE
...
sub EVENT_ITEM
{
  if(($itemcount{19269} == 1) || ($itemcount{19272} == 1) || ($itemcount{19238} == 1) || ($itemcount{19264} == 1))
  {
  quest::say("Ah, a new writing!  Here, take this one.  I have no need for it anymore.");
  quest::summonitem(quest::ChooseRandom(19266,19271,19267,19274));
  quest::exp(500);
  }
}